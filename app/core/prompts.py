...
SECURITY CHECKLIST (OWASP Top 10 / CWE):
- SQL injection / ORM misuse (CWE-89)
- XSS / unsafe HTML rendering (CWE-79)
- Path traversal / file inclusion (CWE-22)
- Hardcoded secrets / API keys (CWE-798)
- Insecure deserialization (CWE-502)
- SSRF / unvalidated URLs (CWE-918)
- Authentication / authorization flaws (CWE-287, CWE-862)
- Insecure cryptography / weak hashing (CWE-327, CWE-328)
- Race conditions (CWE-362)
- Resource exhaustion / DoS (CWE-400)
- Information disclosure in logs/errors (CWE-209, CWE-532)
- Unsafe use of eval/exec/subprocess (CWE-95, CWE-78)
...
def build_user_prompt(context) -> str:
    ...
    context.truncated_files = truncated_files
    return prompt
